...
public class ErisTasksControllerTest {
    ...
    private Task task;
    private String prefix = "/api/secure/tasks";
    ...
    @BeforeEach
    void setup() {
        mockMvc = MockMvcBuilders.standaloneSetup(erisTasksController).build();
        task = new Task();
        task.setName("test");
    ...
    void getAllTasks() throws Exception {
        ...
        this.mockMvc.perform(get(prefix + "/getAllTasks"))
    ...
    void saveTask() throws Exception {
        ...
        this.mockMvc.perform(post(prefix + "/saveTask")
